...
function init_map() {
    var myOptions = {
        ...
        center: new google.maps.LatLng(-32.22278, 152.530364),
    ...
    map.set("styles", [{
            ...
            stylers: [{ color: "#949896" }, { weight: 0.25 }, { lightness: 75 }]
        },
        {
        ...
        {
            featureType: "water",
            stylers: [{ color: "#8cbfc9" }, { lightness: 50 }]
        },
        {
            featureType: "poi",
        ...
        },
        {
            ...
            stylers: [{ color: "#89cb97" }]
        }
    ]);

    var icon = {
        url: "images/map.jpg", // url
    ...
    marker = new google.maps.Marker({
        icon: icon,
        map: map,
        position: new google.maps.LatLng(-32.22278, 152.530364)
    });
    infowindow = new google.maps.InfoWindow({
        content: "<strong>The Gardens at Lakeside</strong><br> 13 Tea Tree Rd, Forster NSW 2428<br>"
    });
